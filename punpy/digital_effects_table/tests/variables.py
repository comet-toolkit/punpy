...
COMMON_VARIABLES_SERIES = {"wavelength": {"dim": [WL_DIM],
                           ...
                           "viewing_zenith_angle": {"dim": [SERIES_DIM],
                                                    ...
                                                    "encoding": {'dtype': np.uint16, "scale_factor": 0.0028,
                                                                 "offset": 0.0}},
...
L0_RAD_VARIABLES = {"integration_time": {"dim": [SCAN_DIM],
                    ...
                    "u_rel_random_digital_number": {"dim": [WL_DIM, SCAN_DIM],
                                                     "dtype": np.float32,
                                                     "attributes": {"standard_name": "random relative uncertainty on digital number",
                    ...
                    #                               "long_name": "series_id",
                    #                               "units": "-"}}
                    "dark_signal": {"dim": [WL_DIM, SCAN_DIM],
                                       "dtype": np.uint32,
                                       "attributes": {"standard_name": "dark_digital_number",
...
CAL_VARIABLES = {"wavelengths": {"dim": [WL_DIM],
                                          "dtype": np.float32,
                                          "attributes": {"standard_name": "wavelengths",
                 ...
                 "gains": {"dim": [WL_DIM],
                                  ...
                                  "attributes": {"standard_name": "gains",
                                                 ...
                                                 "unc_comps": ["u_rel_systematic_indep_gains","u_rel_systematic_corr_rad_irr_gains"]
                                  },
                 "u_rel_systematic_indep_gains": {"dim": [WL_DIM],
                                              "dtype": np.float32,
                                              "attributes": {"standard_name": "independent systematic relative uncertainty on gains",
                                              ...
                                              "encoding": {'dtype': np.uint16, "scale_factor": 0.0001, "offset": 0.0}},
                 "u_rel_systematic_corr_rad_irr_gains": {"dim": [WL_DIM],
                                           "dtype": np.float32,
                                           "attributes": {"standard_name": "systematic relative uncertainty on gains (correlated radiance and irradiance)",
                 ...
                 "wavelength_coefficients": {"dim": [WC_DIM],
                                  "dtype": np.float32,
...
L1A_RAD_VARIABLES = {"radiance": {"dim": [WL_DIM, SCAN_DIM],
                                  "dtype": np.float32,
                                  "attributes": {"standard_name": "radiance",
                                                 "long_name": "upwelling radiance",
                                                 "units": "mW m^-2 nm^-1 sr^-1",
                                                 "unc_comps": ["u_rel_random_radiance","u_rel_systematic_indep_radiance","u_rel_systematic_corr_rad_irr_radiance"]}},
                     "u_rel_random_radiance": {"dim": [WL_DIM, SCAN_DIM],
                                           "dtype": np.uint16,
                                           "attributes": {"standard_name": "random relative uncertainty on radiance",
                                           ...
                                           "encoding": {'dtype': np.uint16, "scale_factor": 0.0001, "offset": 0.0}},
                     "u_rel_systematic_indep_radiance": {"dim": [WL_DIM, SCAN_DIM],
                                               "dtype": np.uint16,
                                               "attributes": {"standard_name": "independent systematic relative uncertainty on radiance",
                                               ...
                                               "encoding": {'dtype': np.uint16, "scale_factor": 0.0001, "offset": 0.0}},
                     "u_rel_systematic_corr_rad_irr_radiance": {"dim": [WL_DIM, SCAN_DIM],
                                               "dtype": np.uint16,
                                               "attributes": {"standard_name": "systematic relative uncertainty on radiance, correlated with irradiance",
...
L1A_IRR_VARIABLES = {"irradiance": {"dim": [WL_DIM, SCAN_DIM],
                                    "dtype": np.float32,
                                    "attributes": {"standard_name": "irradiance",
                                                   "long_name": "downwelling irradiance",
                                                   "units": "mW m^-2 nm^-1 sr^-1",
                                                   "unc_comps": ["u_rel_random_radiance","u_rel_systematic_indep_radiance","u_rel_systematic_corr_rad_irr_radiance"]}},
                     "u_rel_random_irradiance": {"dim": [WL_DIM, SCAN_DIM],
                                             "dtype": np.uint16,
                                             "attributes": {"standard_name": "random relative uncertainty on irradiance",
                                             ...
                                             "encoding": {'dtype': np.uint16, "scale_factor": 0.0001, "offset": 0.0}},
                     "u_rel_systematic_indep_irradiance": {"dim": [WL_DIM, SCAN_DIM],
                                                 "dtype": np.uint16,
                                                 "attributes": {"standard_name": "independent systematic relative uncertainty on irradiance",
                                                 ...
                                                 "encoding": {'dtype': np.uint16, "scale_factor": 0.0001, "offset": 0.0}},
                     "u_rel_systematic_corr_rad_irr_irradiance": {"dim": [WL_DIM, SCAN_DIM],
                                                 "dtype": np.uint16,
                                                 "attributes": {"standard_name": "systematic relative uncertainty on irradiance, correlated with radiance",
...
L1B_RAD_VARIABLES = {"radiance": {"dim": [WL_DIM, SERIES_DIM],
                                  "dtype": np.float32,
                                  "attributes": {"standard_name": "radiance",
                                                 "long_name": "upwelling radiance",
                                                 "units": "mW m^-2 nm^-1 sr^-1",
                                                 "unc_comps": ["u_rel_random_radiance","u_rel_systematic_indep_radiance","u_rel_systematic_corr_rad_irr_radiance"]}},
                     "u_rel_random_radiance": {"dim": [WL_DIM, SERIES_DIM],
                                           "dtype": np.float32,
                                           "attributes": {"standard_name": "random relative uncertainty on radiance",
                                                          "long_name": "random relative uncertainty on upwelling radiance",
                                                          "units": "-"},
                                           "encoding": {'dtype': np.uint16, "scale_factor": 0.0001, "offset": 0.0}},
                     "u_rel_systematic_indep_radiance": {"dim": [WL_DIM, SERIES_DIM],
                                               "dtype": np.float32,
                                               "attributes": {"standard_name": "independent systematic relative uncertainty on radiance",
                                                              "long_name": "the systematic relative uncertainty component on upwelling radiance that is not correlated with irradiance",
                                                              "units": "-"},
                                               "encoding": {'dtype': np.uint16, "scale_factor": 0.0001, "offset": 0.0}},
                     "u_rel_systematic_corr_rad_irr_radiance": {"dim": [WL_DIM, SERIES_DIM],
                                               "dtype": np.float32,
                                               "attributes": {"standard_name": "systematic relative uncertainty on radiance, correlated with irradiance",
...
L1B_IRR_VARIABLES = {"irradiance": {"dim": [WL_DIM, SERIES_DIM],
                                    "dtype": np.float32,
                                    "attributes": {"standard_name": "irradiance",
                                                   "long_name": "downwelling irradiance",
                                                   "units": "mW m^-2 nm^-1 sr^-1",
                                                   "unc_comps": ["u_rel_random_radiance","u_rel_systematic_indep_radiance","u_rel_systematic_corr_rad_irr_radiance"]}},
                     "u_rel_random_irradiance": {"dim": [WL_DIM, SERIES_DIM],
                                             "dtype": np.float32,
                                             "attributes": {"standard_name": "random relative uncertainty on irradiance",
                                                            "long_name": "random relative uncertainty on downwelling irradiance",
                                                            "units": "-"},
                                             "encoding": {'dtype': np.uint16, "scale_factor": 0.0001, "offset": 0.0}},
                     "u_rel_systematic_indep_irradiance": {"dim": [WL_DIM, SERIES_DIM],
                                                 "dtype": np.float32,
                                                 "attributes": {"standard_name": "independent systematic relative uncertainty on irradiance",
                                                                "long_name": "the systematic relative uncertainty component on downwelling irradiance that is not correlated with radiance",
                                                                "units": "-"},
                                                 "encoding": {'dtype': np.uint16, "scale_factor": 0.0001, "offset": 0.0}},
                     "u_rel_systematic_corr_rad_irr_irradiance": {"dim": [WL_DIM, SERIES_DIM],
                                                 "dtype": np.float32,
                                                 "attributes": {"standard_name": "systematic relative uncertainty on irradiance, correlated with radiance",
                                                                "long_name": "the systematic relative uncertainty component on downwelling irradiance that is correlated with radiance",
                                                                "units": "-"},
...
W_L1C_VARIABLES = {"downwelling_radiance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                            "dtype": np.float32,
                                            "attributes": {"standard_name": "radiance",
                                                           "long_name": "downwelling radiance",
                                                           "units": "mW m^-2 nm^-1 sr^-1",
                                                           "unc_comps": ["u_rel_random_radiance","u_rel_systematic_indep_radiance","u_rel_systematic_corr_rad_irr_radiance"]}},
                   "u_rel_random_downwelling_radiance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                                     "dtype": np.float32,
                                                     "attributes": {"standard_name": "random relative uncertainty on radiance",
                                                                    "long_name": "random relative uncertainty on upwelling radiance",
                                                                    "units": "-"},
                                                     "encoding": {'dtype': np.uint16, "scale_factor": 0.0001, "offset": 0.0}},
                   "u_rel_systematic_indep_downwelling_radiance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                                         "dtype": np.float32,
                                                         "attributes": {
                                                             ...
                                                             "units": "-"},
                                                         "encoding": {'dtype': np.uint16, "scale_factor": 0.0001, "offset": 0.0}},
                   "u_rel_systematic_corr_rad_irr_downwelling_radiance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                                         "dtype": np.float32,
                                                         "attributes": {
                   ...
                   "upwelling_radiance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                          ...
                                          "attributes": {"standard_name": "radiance",
                                                         ...
                                                         "units": "mW m^-2 nm^-1 sr^-1",
                                                         "unc_comps": ["u_rel_random_radiance","u_rel_systematic_indep_radiance","u_rel_systematic_corr_rad_irr_radiance"]}},
                   "u_rel_random_upwelling_radiance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                                   "dtype": np.float32,
                                                   "attributes": {"standard_name": "random relative uncertainty on radiance",
                                                                  "long_name": "random relative uncertainty on upwelling radiance",
                                                                  "units": "-"},
                                                   "encoding": {'dtype': np.uint16, "scale_factor": 0.0001, "offset": 0.0}},
                   "u_rel_systematic_indep_upwelling_radiance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                                       "dtype": np.float32,
                                                       "attributes": {
                                                           "standard_name": "independent systematic relative uncertainty on radiance",
                                                           "long_name": "the systematic relative uncertainty component on upwelling radiance that is not correlated with irradiance",
                                                           "units": "-"},
                                                       "encoding": {'dtype': np.uint16, "scale_factor": 0.0001, "offset": 0.0}},
                   "u_rel_systematic_corr_rad_irr_upwelling_radiance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                                       "dtype": np.float32,
                                                       "attributes": {
                                                           "standard_name": "systematic relative uncertainty on radiance",
                                                           "long_name": "the systematic relative uncertainty component on upwelling radiance that is correlated with irradiance",
                   ...
                   "irradiance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                  ...
                                  "attributes": {"standard_name": "irradiance",
                                                 ...
                                                 "units": "mW m^-2 nm^-1 sr^-1",
                                                 "unc_comps": ["u_rel_random_radiance","u_rel_systematic_indep_radiance","u_rel_systematic_corr_rad_irr_radiance"]}},
                   "u_rel_random_irradiance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                           "dtype": np.float32,
                                           "attributes": {"standard_name": "random relative uncertainty on irradiance",
                                                          "long_name": "random relative uncertainty on downwelling irradiance",
                                                          "units": "-"},
                                           "encoding": {'dtype': np.uint16, "scale_factor": 0.0001, "offset": 0.0}},
                   "u_rel_systematic_indep_irradiance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                               "dtype": np.float32,
                                               "attributes": {"standard_name": "independent systematic relative uncertainty on irradiance",
                                                              "long_name": "the systematic relative uncertainty component on downwelling irradiance that is not correlated with radiance",
                                                              "units": "-"},
                                               "encoding": {'dtype': np.uint16, "scale_factor": 0.0001, "offset": 0.0}},
                   "u_rel_systematic_corr_rad_irr_irradiance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                               "dtype": np.float32,
                                               "attributes": {"standard_name": "systematic relative uncertainty on irradiance, correlated with radiance",
                                                              "long_name": "the systematic relative uncertainty component on downwelling irradiance that is correlated with radiance",
                                                              "units": "-"},
...
L_L2A_REFLECTANCE_VARIABLES = {"reflectance": {"dim": [WL_DIM, SERIES_DIM],
                                               "dtype": np.float32,
                                               "attributes": {"standard_name": "reflectance",
                                                              ...
                                                              "units": "-",
                                                              "unc_comps": ["u_rel_random_radiance","u_rel_systematic_indep_radiance","u_rel_systematic_corr_rad_irr_radiance"]}},
                               "u_rel_random_reflectance": {"dim": [WL_DIM, SERIES_DIM],
                                                        "dtype": np.float32,
                                                        "attributes": {"standard_name": "u_rel_random_reflectance",
                                                                       "long_name": "Random reflectance relative uncertainty",
                                                                       "units": "%"},
                                                        "encoding": {'dtype': np.uint16, "scale_factor": 0.0001, "offset": 0.0}},
                               "u_rel_systematic_reflectance": {"dim": [WL_DIM, SERIES_DIM],
                                                            "dtype": np.float32,
                                                            "attributes": {"standard_name": "u_rel_systematic_reflectance",
...
W_L1C_REFLECTANCE_VARIABLES = {"reflectance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                               ...
                               "u_rel_random_water_leaving_radiance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                                                   ...
                                                                   "encoding": {'dtype': np.uint16,
                                                                                "scale_factor": 0.0001,
                                                                                "offset": 0.0}},
                               "u_rel_systematic_water_leaving_radiance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                                                       "dtype": np.float32,
                                                                       "attributes": {
                               ...
                               "corr_systematic_water_leaving_radiance": {"dim": [WL_DIM, WL_DIM],
                                                                          ...
                                                                          "attributes": {
                                                                              ...
                                                                              "units": "-"},
                                                                          "encoding": {'dtype': np.int8, "scale_factor": 0.01, "offset": 0.0}},
                               "u_rel_random_reflectance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                                        "dtype": np.float32,
                                                        "attributes": {
                                                        ...
                                                        "encoding": {'dtype': np.uint16, "scale_factor": 0.0001,
                                                                     "offset": 0.0}},
                               "u_rel_systematic_reflectance": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                                            "dtype": np.float32,
                                                            "attributes": {
                               ...
                               "corr_systematic_reflectance": {"dim": [WL_DIM, WL_DIM],
                                                               ...
                                                               "attributes": {
                                                                   ...
                                                                   "units": "-"},
                                                               "encoding": {'dtype': np.int8, "scale_factor": 0.01, "offset": 0.0}},
                               "u_rel_random_reflectance_nosc": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                                             "dtype": np.float32,
                                                             "attributes": {
                                                             ...
                                                             "encoding": {'dtype': np.uint16, "scale_factor": 0.0001,
                                                                          "offset": 0.0}},
                               "u_rel_systematic_reflectance_nosc": {"dim": [WL_DIM, Lu_SCAN_DIM],
                                                                 "dtype": np.float32,
                                                                 "attributes": {
                                                                     "standard_name":
                                                                         "u_rel_systematic_water_leaving_reflectance_nosc",
                               ...
                               "u_rel_random_epsilon": {"dim": [Lu_SCAN_DIM],
                                                        ...
                                                        "encoding": {'dtype': np.uint16, "scale_factor": 0.0001,
                                                                     "offset": 0.0}},
                               "u_rel_systematic_epsilon": {"dim": [Lu_SCAN_DIM],
                                                            "dtype": np.float32,
                                                            "attributes": {
...
L_L2B_REFLECTANCE_VARIABLES = {"reflectance": {"dim": [WL_DIM, SERIES_DIM],
                                               "dtype": np.float32,
                                               "attributes": {"standard_name": "reflectance",
                                                              "long_name": "The surface called surface means the lower "
                                                                           "boundary of the atmosphere. "
...
VARIABLES_DICT_DEFS: Any = {"L0_RAD": {**COMMON_VARIABLES_SCAN, **L0_RAD_VARIABLES},
                            ...
                            "W_L1C": {**COMMON_VARIABLES_Lu_SCAN,**W_L1C_VARIABLES, **W_L1C_REFLECTANCE_VARIABLES},
