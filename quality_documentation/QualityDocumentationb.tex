...
\begin{itemize}
\item User requirements: Included as Section 2 in `punpy\_requirements.docx' (a separate document in this folder).

\item Functional requirements: Included as Section 3 in `punpy\_requirements.docx' (a separate document in this folder).
