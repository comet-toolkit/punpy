...
version = punpy.__version__
# The full version, including alpha/beta/rc tags.
release = punpy.__version__
...
man_pages = [(master_doc, "punpy", "punpy Documentation", [author], 1)]
